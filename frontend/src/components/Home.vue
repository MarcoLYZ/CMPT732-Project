<template>
  <div class="home">
    <ul>
      <li>
        <a
          href="../../static/html_page/map_heatmap.html"
          target="_blank"
        >
          HeatMap
        </a>
      ...
      <li>
        <a
          href="../../static/html_page/map_circle.html"
          target="_blank"
        >
          CircleMap
        </a>
      ...
      <li>
        <a
          href="../../static/html_page/map_neigh.html"
          target="_blank"
        >
          NeighborMap
        </a>
    ...
    <el-row>
      <!--<el-link :href="www.runoob.com" target="_blank" class="buttonText"  type="primary" :underline="false">详情</el-link>-->
    </el-row>
    <el-row>
